...
# DVE full session
# Saved on Wed Sep 13 21:04:59 2023
# Designs open: 1
#   Sim: /afs/andrew.cmu.edu/usr3/jtbell/private/18240/18240_lab/Lab1/simv
...
#<Session mode="Full" path="/afs/andrew.cmu.edu/usr3/jtbell/private/18240/18240_lab/Lab1/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{0 65} {1919 1041}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 165} {height 700} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 165} {height 700} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 178]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1271
...
if { ![gui_is_db_opened -db {/afs/andrew.cmu.edu/usr3/jtbell/private/18240/18240_lab/Lab1/simv}] } {
gui_sim_run Ucli -exe simv -args { -q -nc -ucligui} -dir /afs/andrew.cmu.edu/usr3/jtbell/private/18240/18240_lab/Lab1 -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { top.win top.error top.a top.b top.c top.d top.e top.f }
...
catch { gui_list_select -id ${Data.1} {top.DUT.a }}
...
gui_open_source -id ${Source.1}  -replace -active top /afs/andrew.cmu.edu/usr3/jtbell/private/18240/18240_lab/Lab1/Loteria.sv
...
gui_sch_show -window ${Schematic.1} -name top
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.1}]
gui_zoom -window ${Schematic.1} -rect { {-3880 -17990} {46843 4167} }
...
gui_path_show -window ${Schematic.2} -objects {top.DUT.win top.T.win top.win}
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.2}]
gui_zoom -window ${Schematic.2} -rect { {-5697 -7668} {20030 3570} }
...
gui_sch_show -window ${Schematic.3} -name top.DUT
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.3}]
gui_zoom -window ${Schematic.3} -rect { {-33933 -59617} {122588 5309} }
